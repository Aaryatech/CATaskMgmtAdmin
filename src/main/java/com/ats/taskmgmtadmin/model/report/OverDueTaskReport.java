...
public class OverDueTaskReport { //Same Bean used for emp work diary report.
	...
	private String taskWorkDate; //ie taskEndDate in Db Table
	...
	private String  statusText; //Current Status of task
	...
	public String getTaskWorkDate() {
		return taskWorkDate;
	}
	public void setTaskWorkDate(String taskWorkDate) {
