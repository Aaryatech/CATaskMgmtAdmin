					...
					<div class="col-md-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<form
									action="${pageContext.request.contextPath}/updateCustomerIsActiveStatus"
									...
									<div class="form-group row">
										...
										<div class="col-lg-2">
											...
											<input type="text" class="form-control"
												placeholder="Customer Name" id="serviceName"
												value="${custName.custName}" name="serviceName"
												autocomplete="off" onchange="trim(this)" readonly="readonly">

											<input type="hidden" id="custId" name="custId"
												value="${custName.custId}">
