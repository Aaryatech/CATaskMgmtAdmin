					...
					<div class="table-responsive">
						<table class="table text-nowrap">
							...
							<tbody>
								...
								<tr>
									<td>
										<a href="#" class="text-default font-weight-semibold">Employee A</a>
									</td>
								 ...
								 <tr>
									<td>
										<a href="#" class="text-default font-weight-semibold">Employee B</a>
									</td>
								...
								<tr>
									<td>
										<a href="#" class="text-default font-weight-semibold">Employee C</a>
									</td>
