					...
					<div class="table-responsive">
						<table class="table text-nowrap">
							...
							<tbody>
								...
								<tr>
									<td><a href="#" class="text-default font-weight-semibold">Abhiman</td>
									<td>Pending</td>
									<td></td>
									<td></td>
									<td></td>
								 ...
								 <tr>
									<td><a href="#" class="text-default font-weight-semibold">Sameer</td>
									<td>Pending</td>
									<td></td>
									<td></td>
									<td></td>
								...
								<tr>
									<td><a href="#" class="text-default font-weight-semibold">Omni Corp</td>
									<td>Pending for client</td>
									<td></td>
									<td></td>
									<td></td>
									<td></td>
								...
								<tr>
									<td><a href="#" class="text-default font-weight-semibold">Corpo Kin</a></td>
									<td>Pending</td>
									<td></td>
									<td></td>
									<td></td>
